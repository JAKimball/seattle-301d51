...
function displayPics(){
  ...
  // While `var` when used in a function will declare the variable scoped for the entire function, `let` declares the variable with a scope of just the block that it is declared for, and the variable is only assignable or readable after it is declared.
  console.log(viewed);
